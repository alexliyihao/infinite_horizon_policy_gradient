...
def gradient_estimate_benchmark(policy_0, policy_1, env, rolling_out_start_recording, rolling_out_step, n_rolling_out):
    """
...
def gradient_estimate_causality(policy_0, policy_1, env, rolling_out_start_recording, rolling_out_step, n_rolling_out):
    """
...
def gradient_estimate_baseline(policy_0, policy_1, env, rolling_out_start_recording, rolling_out_step, n_rolling_out):
    """
...
def gradient_estimate_ihp1(policy_0, policy_1, env, rolling_out_start_recording, rolling_out_step, n_rolling_out, in_policy = False):
    """
    ...
    for time_step_ in tqdm(range(n_rolling_out), desc = "ihp1", leave = False):
        # rollout policy 0
        _ , reward_list , triple_pi_count_0 , state_f_0 , state_list_0 = roll_out_procedure(policy = policy_0,
                                                                                            environment = env,
                                                                                            record_from = rolling_out_start_recording,
                                                                                            rolling_length = rolling_out_step,
                                                                                            ihp = True)
...
def gradient_estimate_aggregate(policy_0,
    ...
    for time_step_ in tqdm(range(n_rolling_out), desc = "rolling out", leave= False):
        ...
        _ , _ , triple_pi_count_1, state_f_1, state_list_1 = roll_out_procedure(policy = policy_1_ihp1,
                                                                                environment = env,
                                                                                record_from = rolling_out_start_recording,
                                                                                rolling_length = rolling_out_step,
                                                                                ihp = True)
        ...
        # approximate w for policy 1
        w_approxi = direct_solve_least_square(policy_1_ihp1,
                                              triple_pi_count_1,
                                              grad_log_ihp1,
                                              state_list_1
                                              )
